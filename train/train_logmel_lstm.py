...
def train_model(model, trainx, trainy, testx, testy, epochs, batch_size, log_dir, save_model_dir):
    ...
    plot_model(model, to_file='../model_logmel_lstm_plot.png', show_shapes=True, show_layer_names=True)
    ...
    model.save(os.path.join(save_model_dir, 'logmel_lstm_epoch{}_bs{}.h5'.format(epochs, batch_size)))
